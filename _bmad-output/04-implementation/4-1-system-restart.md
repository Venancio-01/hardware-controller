...
- [Source: _bmad-output/02-planning/epics.md#Story 4.1: 实现系统重启功能] - 用户故事和验收标准
- [Source: _bmad-output/03-solutioning/architecture.md#API Endpoints] - API 设计模式
- [Source: _bmad-output/00-project-knowledge/project-context.md#优雅关闭处理] - 优雅关闭实现要求
...
- packages/frontend/src/components/system/RestartButton.tsx
- packages/frontend/src/services/system-api.ts
- packages/frontend/src/hooks/useRestartSystem.ts
- packages/frontend/src/hooks/useAutoReconnect.ts
...
- packages/frontend/src/hooks/__tests__/useRestartSystem.test.ts